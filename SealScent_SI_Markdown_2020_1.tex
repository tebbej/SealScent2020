...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{anova}\NormalTok{(}\KeywordTok{betadisper}\NormalTok{(}\KeywordTok{vegdist}\NormalTok{(scent), peak_factors}\OperatorTok{$}\NormalTok{age))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{anova}\NormalTok{(}\KeywordTok{betadisper}\NormalTok{(}\KeywordTok{vegdist}\NormalTok{(scent), scent_nmds}\OperatorTok{$}\NormalTok{BeachAge))}
\end{Highlighting}
\end{Shaded}
